...
$form_id = isset($_REQUEST["form_id"]) ? htmlspecialcharsbx($_REQUEST["form_id"]) : 1;
//$form_id = htmlspecialcharsbx($form_id);
// echo 123;
...
<?elseif($form_id == 'sms_confirmation'):?>
	<?include('sms_confirmation.php');?>
<?elseif($form_id == 'sms_confirmationEmail'):?>
	<?include('sms_confirmationEmail.php');?>
