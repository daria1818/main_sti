...
$dbElements = CIBlockElement::GetList([], ['ID' => $arProducts, 'IBLOCK_ID' => 81, 'ACTIVE' => 'Y'], false, false, ['ID', 'PROPERTY_CML2_LINK']);
while ($arElements = $dbElements->Fetch())
{
	$arProducts[] = $arElements['PROPERTY_CML2_LINK_VALUE'];
}
global $NEXT_SMART_FILTER;
$NEXT_SMART_FILTER['ID'] = $arProducts;
if($isAjax=="N"){
...
$arParams = array(
	...
	"OFFERS_SORT_FIELD" => "CATALOG_PRICE_3",
...
<div class="js_wrapper_items" data-params='<?=str_replace('\'', '"', CUtil::PhpToJSObject($arParams, false))?>'>
