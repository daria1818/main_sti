...
$APPLICATION->SetPageProperty("TITLE", "Помощь в оформлении заказа на сайте Stionline");
$APPLICATION->SetPageProperty("description", "Помощь и ответы на вопросы интернет-магазина Stionline. Широкий выбор товаров для стоматологов и зубных техников. Заказ на сайте или по ☎️ +7 495 118-37-87");
