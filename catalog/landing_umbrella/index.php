...
<?
if($_GET['rel'] == 'MailingList' && isset($_GET['rel']) && false === strpos($_SERVER['SCRIPT_URL'], 'landing_umbrella')){?>
  <!DOCTYPE html>
  <html lang="ru">
  <head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="/catalog/landing_umbrella/assets/plugins/swiper/swiper-bundle.min.css">
    <link rel="stylesheet" href="/catalog/landing_umbrella/css/global.css">
    <script
  ...
  <body>
      ...
      <div class="header-menu">
        <div class="header-logo">
          ...
          <a class="header-logo__link" href="/">
            <img src="/catalog/landing_umbrella/assets/img/logo.header.svg" alt="logo" loading="lazy">
          </a>
        ...
        <div class="header-option">
          ...
          <div class="header-feedback-form">
            <button class="header-btn js-call-order" type="button" aria-label="request-call">
              ...
              <svg class="icon call">
                <use href="/catalog/landing_umbrella/assets/svg/sprite.svg#call"></use>
              </svg>
            </button>
          </div>
        </div>
    ...
    <div class="popup-close js-close">
      <svg class="icon icon-close">
        <use href="/catalog/landing_umbrella/assets/svg/sprite.svg#icon-close"></use>
      </svg>
    </div>
  </div>
          ...
          <section class="banner">
            <div class="banner__info">
              <div class="banner__logo">
                <img src="/catalog/landing_umbrella/assets/img/logo.banner.svg" alt="logo" loading="lazy">
              </div>
            ...
            <div class="banner__img">
              <picture>
                <source srcset="/catalog/landing_umbrella/assets/img/banner.webp" type="image/webp">
                <img src="/catalog/landing_umbrella/assets/img/banner.png" alt="banner">
              </picture>
            </div>
          </section>
              ...
              <div class="advantage-box">
                <div class="advantage__item-big">
                  ...
                  <div class="advantage__img">
                    <picture>
                      <source srcset="/catalog/landing_umbrella/assets/img/img.webp" type="image/webp">
                      <img src="/catalog/landing_umbrella/assets/img/img.png" alt="Идельный . Фото">
                    </picture>
                  </div>
                </div>
              ...
              <div class="advantage-container">
                ...
                <div class="advantage__item">
                  ...
                  <div class="advantage__img-mini">
                    <picture>
                      <source srcset="/catalog/landing_umbrella/assets/img/capli.webp" type="image/webp">
                      <img src="/catalog/landing_umbrella/assets/img/capli.png" alt="Подходит для пациентов с аллергией на латекс">
                    </picture>
                  </div>
                </div>
              </div>
                  ...
                  <div class="methods-item">
                    <div class="methods-item__img">
                      <picture>
                        ...
                        <img src="/catalog/landing_umbrella/assets/img/f1.jpg" alt="Лучше визуализация при осмотре" loading="lazy">
                      </picture>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="methods-item">
                    <div class="methods-item__img">
                      <picture>
                        <!-- <source srcset="./assets/img/methods-slider.webp" type="image/webp"> -->
                        <img src="/catalog/landing_umbrella/assets/img/f2.jpg" alt="Контроль прикуса" loading="lazy">
                      </picture>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="methods-item">
                    <div class="methods-item__img">
                      <picture>
                        <!-- <source srcset="./assets/img/methods-slider.webp" type="image/webp"> -->
                        <img src="/catalog/landing_umbrella/assets/img/f3.jpg" alt="Регистрация прикуса" loading="lazy">
                      </picture>
                    </div>
                  ...
                  <div class="methods-item">
                    <div class="methods-item__img">
                      <picture>
                        ...
                        <img src="/catalog/landing_umbrella/assets/img/f4.jpg" alt="Фиксация брекетов" loading="lazy">
                      </picture>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="methods-item">
                    <div class="methods-item__img">
                      <picture>
                        <!-- <source srcset="./assets/img/capa.webp" type="image/webp"> -->
                        <img src="/catalog/landing_umbrella/assets/img/f5.jpg" alt="Снятие оттиска с двух челюстей (снятие оттиска в прикусе)" loading="lazy">
                      </picture>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="methods-item">
                    <div class="methods-item__img">
                      <picture>
                        <!-- <source srcset="./assets/img/capa.webp" type="image/webp"> -->
                        <img src="/catalog/landing_umbrella/assets/img/f6.jpg" alt="Снятие оттиска" loading="lazy">
                      </picture>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="methods-item">
                    <div class="methods-item__img">
                      <picture>
                        <!-- <source srcset="./assets/img/capa.webp" type="image/webp"> -->
                        <img src="/catalog/landing_umbrella/assets/img/f7.jpg" alt="Улучшенный доступ для препарирования" loading="lazy">
                      </picture>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="methods-item">
                    <div class="methods-item__img">
                      <picture>
                        <!-- <source srcset="./assets/img/capa.webp" type="image/webp"> -->
                        <img src="/catalog/landing_umbrella/assets/img/f8.jpg" alt="Офисное отбеливание" loading="lazy">
                      </picture>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="methods-item">
                    <div class="methods-item__img">
                      <picture>
                        <!-- <source srcset="./assets/img/capa.webp" type="image/webp"> -->
                        <img src="/catalog/landing_umbrella/assets/img/f9.jpg" alt="Непрямая фиксация брекетов" loading="lazy">
                      </picture>
                    </div>
            ...
            <div class="methods__slider-nav">
              ...
              <div class="swiper-prev nav-prev">
                <svg class="icon nav-btns">
                  <use href="/catalog/landing_umbrella/assets/svg/sprite.svg#nav-btns"></use>
                </svg>
              </div>
                  ...
                  <div class="swiper-slide">
                    <div class="instruction-item">
                      ...
                      <div class="instruction-item__img">
                        <picture>
                          <!-- <source srcset="./assets/img/capa.webp" type="image/webp"> -->
                          <img src="/catalog/landing_umbrella/assets/img/step1.jpg" alt="Шаг 1" loading="lazy">
                        </picture>
                      </div>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="instruction-item">
                      ...
                      <div class="instruction-item__img">
                        <picture>
                          <!-- <source srcset="./assets/img/capa.webp" type="image/webp"> -->
                          <img src="/catalog/landing_umbrella/assets/img/step2.jpg" alt="Шаг 2" loading="lazy">
                        </picture>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="swiper-slide">
                    <div class="instruction-item">
                      ...
                      <div class="instruction-item__img">
                        <picture>
                          <!-- <source srcset="./assets/img/capa.webp" type="image/webp"> -->
                          <img src="/catalog/landing_umbrella/assets/img/step3.jpg" alt="Шаг 3">
                        </picture>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="swiper-slide">
                    <div class="instruction-item">
                      ...
                      <div class="instruction-item__img">
                        <picture>
                          <!-- <source srcset="./assets/img/capa.webp" type="image/webp"> -->
                          <img src="/catalog/landing_umbrella/assets/img/step4.jpg" alt="Шаг 4">
                        </picture>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="swiper-slide">
                    <div class="instruction-item">
                      ...
                      <div class="instruction-item__img">
                        <picture>
                          <!-- <source srcset="./assets/img/capa.webp" type="image/webp"> -->
                          <img src="/catalog/landing_umbrella/assets/img/step5.jpg" alt="Шаг 5">
                        </picture>
                      </div>
                    </div>
                  </div>
              ...
              <div class="instruction__slider-nav">
                <div class="swiper-prev nav-prev2">
                  <svg class="icon nav-btns2">
                    <use href="/catalog/landing_umbrella/assets/svg/sprite.svg#nav-btns2"></use>
                  </svg>
                </div>
          ...
          <section class="product" id="product">
            ...
            <div class="product-size">
              ...
              <div class="product-img">
                <picture>
                  <source srcset="/catalog/landing_umbrella/assets/img/paketi.webp" type="image/webp">
                  <img src="/catalog/landing_umbrella/assets/img/paketi.jpg" alt="Как правильно выбрать размер ретрактора? Фото 1">
                </picture>
              </div>
            </div>
            <div class="product-table">
              <div class="product-table__img">
                <picture>
                  <source srcset="/catalog/landing_umbrella/assets/img/maski.webp" type="image/webp">
                  <img src="/catalog/landing_umbrella/assets/img/maski.jpg" alt="Как правильно выбрать размер ретрактора? Фото 2" loading="lazy">
                </picture>
              </div>
          ...
          <div class="footer-logo">
            <a class="header-logo__link" href="/">
              <svg class="icon logo-footer">
                <use href="/catalog/landing_umbrella/assets/svg/sprite.svg#logo-footer"></use>
              </svg>
            </a>
    ...
    <script defer src="/catalog/landing_umbrella/assets/plugins/swiper/swiper-bundle.min.js"></script>
    <script defer src="/catalog/landing_umbrella/assets/plugins/pristine/pristine.min.js"></script>
    <script defer src="/catalog/landing_umbrella/js/main.js"></script>
  </body>
  </html>
<?}else{
  header("Location: /");
