...
$CODE = $GLOBALS['PAGE'][count($GLOBALS['PAGE'])-2];

$arSelect = Array("ID",'CODE');
$arFilter = Array("IBLOCK_ID"=>$arParams['IBLOCK_ID'], "=CODE"=>$CODE, "ACTIVE"=>"Y");
...
if($arCur){
	...
	$arSelect = Array("ID",'CODE');
	$arFilter = Array("IBLOCK_ID"=>$arParams['IBLOCK_ID'], "PROPERTY_OLDCODE"=>$CODE, "ACTIVE"=>"Y");
	$res = CIBlockElement::GetList(Array(), $arFilter, false, Array(), $arSelect);
	while($ob = $res->Fetch()){
		$arCur = $ob;
	}
