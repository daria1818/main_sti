...
<form method="POST" action="<?echo $APPLICATION->GetCurPage()?>?mid=<?=htmlspecialcharsbx($mid)?>&lang=<?=LANGUAGE_ID?>">
	...
	<? $tabControl->BeginNextTab(); ?>
		...
		<tr class="heading">
	        <td colspan="2"><?= Loc::getMessage('ALFABANK_PAYMENT_STRING_TAX_DEFAULT')?>:</td>
	    </tr>
		<tr>

	        <td width="100%" colspan="2" style="text-align: center;">
	            <select name="TAX_DEFAULT">
	            	<option <?= 0 == $current_settings['TAX_DEFAULT'] ? ' selected' : '' ?> value="0"><?= Loc::getMessage('ALFABANK_TAX_DEFAULT_VALUE_0');?></option>
	            	<option <?= 1 == $current_settings['TAX_DEFAULT'] ? ' selected' : '' ?> value="1"><?= Loc::getMessage('ALFABANK_TAX_DEFAULT_VALUE_1');?></option>
	            	<option <?= 2 == $current_settings['TAX_DEFAULT'] ? ' selected' : '' ?> value="2"><?= Loc::getMessage('ALFABANK_TAX_DEFAULT_VALUE_2');?></option>
	            	<option <?= 4 == $current_settings['TAX_DEFAULT'] ? ' selected' : '' ?> value="4"><?= Loc::getMessage('ALFABANK_TAX_DEFAULT_VALUE_4');?></option>
	            	<option <?= 6 == $current_settings['TAX_DEFAULT'] ? ' selected' : '' ?> value="6"><?= Loc::getMessage('ALFABANK_TAX_DEFAULT_VALUE_6');?></option>
	            	<option <?= 7 == $current_settings['TAX_DEFAULT'] ? ' selected' : '' ?> value="7"><?= Loc::getMessage('ALFABANK_TAX_DEFAULT_VALUE_7');?></option>
	            </select>
	        </td>
	    </tr>
		...
		<tr class="extra-settings active">
	        ...
	        <td width="50%" class="alfabank-input-top adm-detail-content-cell-r">
