...
if($bExport){
	...
	//     $previousQuarterStartYear = $currentYear - 1;
	// } elseif ($currentMonth <= 6) {
	//     $previousQuarterStartMonth = 1;
	//     $previousQuarterStartYear = $currentYear;
	...
	// $previousQuarterStartDate = new DateTime("$previousQuarterStartYear-$previousQuarterStartMonth-01");
	// $arFilter[">=DATE_INSERT"] = $previousQuarterStartDate->format('d.m.Y') . ' 00:00:00';

}

/* end Ses upd on 06/03/2024 */
