...
<script type="text/javascript">
	...
	jsWidget.async = true;
	jsWidget.src = "https://pro.aktivator.top/widget/js/widget.js?"+Date.now();
	document.getElementsByTagName("head")[0].appendChild(jsWidget);
</script>
<?
global $USER;
	if ($USER->IsAdmin()){
...
<script type="text/javascript">
   BX.ready(function(){
         BX.addCustomEvent('onAjaxSuccess', function(e,dd){
            if (dd.url == "/bitrix/components/rubyroid/rubyroid.cartpay/ajax.php")
            {
