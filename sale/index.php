...
$APPLICATION->SetPageProperty("description", "⭐⭐⭐ Акции и скидки на стоматологические инструменты и оборудование в интернет-магазине Stionline. Большой выбор. Делайте заказ на сайте или по ☎️: +7 495 118-37-87.");
$APPLICATION->SetPageProperty("title", "stionline.ru - акции и специальные предложения");
