...
if (!empty($arResult['SKU_PROPS'])){
	$arSkuTemplate=CNextCustom::GetSKUPropsArray($arResult['SKU_PROPS'], $arResult["SKU_IBLOCK_ID"], "list", $arParams["OFFER_HIDE_NAME_PROPS"]);
}
...
$templateData["CHARACTERISTICS"] = $showProps;
	...
	$itemIds = array(
		'ID' => $strMainID,
		'DISCOUNT_PERCENT_ID' => $strMainID.'_dsc_pict',
		'STICKER_ID' => $strMainID.'_sticker',
		'BIG_SLIDER_ID' => $strMainID.'_big_slider',
		'BIG_IMG_CONT_ID' => $strMainID.'_bigimg_cont',
		'SLIDER_CONT_ID' => $strMainID.'_slider_cont',
		'OLD_PRICE_ID' => $strMainID.'_old_price',
		'PRICE_ID' => $strMainID.'_price',
		'DESCRIPTION_ID' => $strMainID.'_description',
		'DISCOUNT_PRICE_ID' => $strMainID.'_price_discount',
		'PRICE_TOTAL' => $strMainID.'_price_total',
		'SLIDER_CONT_OF_ID' => $strMainID.'_slider_cont_',
		'QUANTITY_ID' => $strMainID.'_quantity',
		'QUANTITY_DOWN_ID' => $strMainID.'_quant_down',
		'QUANTITY_UP_ID' => $strMainID.'_quant_up',
		'QUANTITY_MEASURE' => $strMainID.'_quant_measure',
		'QUANTITY_LIMIT' => $strMainID.'_quant_limit',
		'BUY_LINK' => $strMainID.'_buy_link',
		'ADD_BASKET_LINK' => $strMainID.'_add_basket_link',
		'BASKET_ACTIONS_ID' => $strMainID.'_basket_actions',
		'NOT_AVAILABLE_MESS' => $strMainID.'_not_avail',
		'COMPARE_LINK' => $strMainID.'_compare_link',
		'TREE_ID' => $strMainID.'_skudiv',
		'DISPLAY_PROP_DIV' => $strMainID.'_sku_prop',
		'DISPLAY_MAIN_PROP_DIV' => $strMainID.'_main_sku_prop',
		'OFFER_GROUP' => $strMainID.'_set_group_',
		'BASKET_PROP_DIV' => $strMainID.'_basket_prop',
		'SUBSCRIBE_LINK' => $strMainID.'_subscribe',
		'TABS_ID' => $strMainID.'_tabs',
		'TAB_CONTAINERS_ID' => $strMainID.'_tab_containers',
		'SMALL_CARD_PANEL_ID' => $strMainID.'_small_card_panel',
		'TABS_PANEL_ID' => $strMainID.'_tabs_panel'
	);


	$haveOffersNew = !empty($arResult['OFFERS']);

	if ($haveOffers)
	{
		$actualItemNew = isset($arResult['OFFERS'][$arResult['OFFERS_SELECTED']])
			? $arResult['OFFERS'][$arResult['OFFERS_SELECTED']]
			: reset($arResult['OFFERS']);
	}else{
		$actualItemNew = $arResult;
	}

	$showSubscribeNew = $arResult['PRODUCT']['SUBSCRIBE'] === 'Y' || $haveOffersNew;
...
<!-- <span style="display:none;" itemprop="reviews" itemscope itemtype="http://schema.org/Review">
	...
	<div class="right_info">
		<div class="info_item">
			...
			<div class="middle_info main_item_wrapper">
				<input type="hidden" name="LIMIT_BASKET" value="<?=(isset($arResult['LIMIT_BASKET']) ? 'Y' : '')?>">
				<input type="hidden" name="LIMIT_SECTION_ID" value="<?=(isset($arResult['LIMIT_SECTION_ID']) ? $arResult['LIMIT_SECTION_ID'] : '')?>">
				<input type="hidden" name="SECTION_NAME" value="<?=(isset($arResult['SECTION_NAME']) ? $arResult['SECTION_NAME'] : '')?>">
						...
						<?
							$APPLICATION->IncludeComponent(
								...
								array(
									...
									'DEFAULT_DISPLAY' => !$actualItemNew['CAN_BUY'],
							...
							<?if (!empty($arResult['OFFERS_PROP'])){?>
								<div class="bx_catalog_item_scu wrapper_sku" id="<? echo $arItemIDs["ALL_ITEM_IDS"]['PROP_DIV']; ?>">
									<?foreach ($arSkuTemplate as $code => $strTemplate){
										...
										$strTemplate = str_replace('title="Срок годности 1С: Базовый"', 'title="Срок годности 1С: Более 14 мес"', $strTemplate);
										$strTemplate = str_replace('Базовый', 'Более 14 мес', $strTemplate);
