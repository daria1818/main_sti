...
/*limit basket*/
$section = CNextCache::CIBlockSection_GetList([], ['IBLOCK_ID' => $arParams['IBLOCK_ID'], 'ID' => $arResult['IBLOCK_SECTION_ID'], '!UF_LIMIT_BASKET' => false], false, ['ID', 'NAME', 'UF_LIMIT_BASKET'], false);
if(!empty($section[0]))
{
	$arResult['LIMIT_SECTION_ID'] = $section[0]['ID'];
	$arResult['LIMIT_BASKET'] = 'Y';
	$arResult['SECTION_NAME'] = $section[0]['NAME'];
}
?>