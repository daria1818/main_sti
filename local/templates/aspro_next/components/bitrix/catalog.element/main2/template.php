...
<?
// $classItem = false;
// if($arResult['IBLOCK_SECTION_ID'] == 8374)
// {
//   $classItem = true;
// }
?>
...
$arResult['SKU_PROPS']['SROK_GODNOSTI_1S']['NAME'] = "Срок годности";
if($arResult['IBLOCK_SECTION_ID'] == 8374)
{
  $arResult['SKU_PROPS']['SROK_GODNOSTI_1S']['NAME'] = "Дата курса";
}
          ...
          <? if ($arResult["OFFERS"] && $showCustomOffer) { ?>
            ...
            <div class="sku_props">
              ...
              <? if (!empty($arResult['OFFERS_PROP'])) { ?>
                ...
                <div class="bx_catalog_item_scu wrapper_sku" id="<? echo $arItemIDs["ALL_ITEM_IDS"]['PROP_DIV']; ?>" style="display:<? echo $classItem == true ? "none" : "" ?>">
                  <!--Было-->
                  ...
                  <!--Стало, переделать!-->
                    ...
                    <div class="bx_item_detail_scu" style="" id="bx_117848907_<?=$arResult["ID"];?>_prop_1361_cont" data-display_type="LI" data-id="1361">
                      <span class="show_class bx_item_section_name"><span><?=$arResult['SKU_PROPS']['SROK_GODNOSTI_1S']['NAME']?></span></span>
                      <div class="bx_scu_scroller_container"><div class="bx_scu" style="display: flex;">
                        <ul id="bx_117848907_<?=$arResult["ID"];?>_prop_1361_list" class="list_values_wrapper">
                          <?$i=1;?>
                          <?
                          usort($arResult["OFFERS"], function ($item1, $item2) {
                              if ($item1['PRICES']['AUTO']['DISCOUNT_VALUE_VAT'] == $item2['PRICES']['AUTO']['DISCOUNT_VALUE_VAT']) {
                                  return 0;
                              }
                              return ($item1['PRICES']['AUTO']['DISCOUNT_VALUE_VAT'] < $item2['PRICES']['AUTO']['DISCOUNT_VALUE_VAT']) ? -1 : 1;
                          });

                          ?>

                          <?foreach($arResult["OFFERS"] as $offer){?>
                      			<?if ($offer['PROPERTIES']['CML2_ATTRIBUTES']['VALUE']['0'] == "Базовый"){
    							               $offer['PROPERTIES']['CML2_ATTRIBUTES']['VALUE']['0'] = 'Более 14 мес';
    							           }?>
                            <li class="" style="" data-treevalue="<?=$offer['PROPERTIES']['SROK_GODNOSTI_1S']['ID'];?>_<?=$offer['TREE']['PROP_1361'];?>" data-showtype="li" data-onevalue="<?=$offer['TREE']['PROP_1361'];?>" title="Срок годности: <?=$offer['PROPERTIES']['CML2_ATTRIBUTES']['VALUE']['0'];?>"><i></i><span class="cnt"><?=$offer['PROPERTIES']['CML2_ATTRIBUTES']['VALUE']['0'];?></span></li>
                              <?$i++;?>
                          <?}?>

                        </ul>
						<?if($arResult['ID'] == '93108'){?>
						           <? $APPLICATION->IncludeFile(SITE_DIR . "include/element_btn_present_buy.php", array(), array("MODE" => "html",  "NAME" => GetMessage('CT_BCE_CATALOG_DOP_DESCR'))); ?>
							<?}?>
                      </div>
                    </div>
                  <?//}?>
...
<div id="modal-present-buy" class="modal-buy">
  <div class="modal-content-my-buy">
    <span class="close-buy">&times;</span>
<script data-b24-form="inline/14/mlgb32" data-skip-moving="true">
	(function(w,d,u){
		var s=d.createElement('script');s.async=true;s.src=u+'?'+(Date.now()/180000|0);
		var h=d.getElementsByTagName('script')[0];h.parentNode.insertBefore(s,h);
	})(window,document,'https://crm.stionline.ru/upload/crm/form/loader_14_mlgb32.js');
</script>
  </div>
</div>
		<?if($arResult['IBLOCK_SECTION_ID'] != '8374'){?>
        <div class="button-present">
            <? $APPLICATION->IncludeFile(SITE_DIR . "include/element_btn_present.php", array(), array("MODE" => "html",  "NAME" => GetMessage('CT_BCE_CATALOG_DOP_DESCR'))); ?>
          </div>
		<?}?>
      </div>
    </div>
...
<?
if (!empty($arResult['BONUS_PRODUCTS'])) { ?>
  <style>
  ...
  <div class="sale-products-gift bx-red" data-entity="sale-products-gift-container">
    <h3>Бонус при покупке:</h3>
    <div class="row product-item-list-col-4" data-entity="items-row">
      <div class="col-xs-12 product-item-small-card">
        <div class="row">
          <? foreach ($arResult['BONUS_PRODUCTS'] as $BProduct) { ?>
            <div class="col-xs-6 col-md-3">
              <div class="product-item-container" id="bx_555460384_26200767_0b58b6311a47ad36aca65989c3383e66" data-entity="item" style="height: auto;">
                <div class="product-item">
                  <a class="product-item-image-wrapper" href="<?= $BProduct['~DETAIL_PAGE_URL'] ?>" title="<?= $BProduct['~NAME'] ?>" data-entity="image-wrapper">
                    <? if (!empty($BProduct['DETAIL_PICTURE']) || !empty($BProduct['PREVIEW_PICTURE'])) {
                      if (!empty($BProduct['PREVIEW_PICTURE'])) { ?>
                        <span class="product-item-image-slider-slide-container slide" style="background-image: url('<?= CFile::GetPath($BProduct['PREVIEW_PICTURE']) ?>');" data-slider-interval="5000" data-slider-wrap="true"></span>
                      <? } else { ?>
                        <span class="product-item-image-slider-slide-container slide" style="background-image: url('<?= CFile::GetPath($BProduct['DETAIL_PICTURE']) ?>');" data-slider-interval="5000" data-slider-wrap="true"></span>
                      <? } ?>
                    <? } else { ?>
                      <span class="product-item-image-slider-slide-container slide" style="background-image: url('/local/templates/aspro_next/components/bitrix/sale.products.gift.basket/.default/images/no_photo.png');" data-slider-interval="5000" data-slider-wrap="true"></span>
                    <? } ?>
                    <div class="product-item-label-ring product-item-label-small product-item-label-middle product-item-label-right" id="bx_555460384_26200767_0b58b6311a47ad36aca65989c3383e66_dsc_perc">
                      <span>-99%</span>
                    </div>
                    <div class="product-item-image-slider-control-container" id="bx_555460384_26200767_0b58b6311a47ad36aca65989c3383e66_pict_slider_indicator" style="display: none;">
                    </div>
                  </a>

                  <div class="clio-box">
                    <div class="product-item-label-text product-item-label-small product-item-label-top product-item-label-left" id="bx_555460384_26200767_0b58b6311a47ad36aca65989c3383e66_sticker">
                      <div>
                        <span title="Подарок">Акция</span>
                      </div>
                    </div>

                    <div class="product-item-title">
                      <a href="<?= $BProduct['~DETAIL_PAGE_URL'] ?>" title="<?= $BProduct['~NAME'] ?>"><?= $BProduct['~NAME'] ?></a>
                    </div>
                    <div class="product-item-info-container product-item-price-container" data-entity="price-block">
                      <span class="product-item-price-old" id="bx_555460384_26200767_0b58b6311a47ad36aca65989c3383e66_price_old"><?= $BProduct['PRICE']['PRICE'] ?> руб.</span>&nbsp;
                      <span class="product-item-price-current" id="bx_555460384_26200767_0b58b6311a47ad36aca65989c3383e66_price">10 руб.</span>
                    </div>
...
var form = document.querySelector('#modal-present');
...
var form = document.querySelector('.b24-form-content form');
/*var xhr = new XMLHttpRequest();
xhr.open("POST", "/get_coin/index.php", true);
