...
<table class="data-table bx-registration-table">
	...
	<tbody>
		...
		<tr>
			<td colspan='2'>
				<div class='form-group animated-labels input-filed'>
					<span><span class="starrequired">*</span><?=GetMessage("AUTH_LOGIN_MIN")?></span>
					<div class="input">
		...
		<tr>
			<td colspan='2'>
				<div class='form-group animated-labels input-filed'>
					<span><span class="starrequired">*</span><?=GetMessage("AUTH_PASSWORD_REQ")?></span>
					<div class="input">
		...
		<tr>
			<td colspan='2'>
				<div class='form-group animated-labels input-filed'>
					<span><span class="starrequired">*</span><?=GetMessage("AUTH_CONFIRM")?></span>
					<div class="input">
...
<?if($arResult["EMAIL_REGISTRATION"]):?>
		<tr>
			<td colspan='2'>
				<div class='form-group animated-labels input-filed'>
					<span><?if($arResult["EMAIL_REQUIRED"]):?><span class="starrequired">*</span><?endif?><?=GetMessage("AUTH_EMAIL")?></span>
					<div class="input">
...
<?if($arResult["PHONE_REGISTRATION"]):?>
		<tr>
			<td colspan='2'>
				<div class='form-group animated-labels input-filed'>
					<span><?if($arResult["PHONE_REQUIRED"]):?><span class="starrequired">*</span><?endif?><?echo GetMessage("main_register_phone_number")?></span>
					<div class="input">
...
<?// ******************** /User properties ***************************************************
	...
	<tfoot>
		<tr>
			<td></td>
			<td><input type="submit" class='btn btn-default bold' name="Register" value="<?=GetMessage("AUTH_REGISTER")?>" /></td>
		</tr>
	</tfoot>
</table>
...
<p><a class='btn transparent bold register' href="<?=$arResult["AUTH_AUTH_URL"]?>" rel="nofollow"><b><?=GetMessage("AUTH_AUTH")?></b></a></p>
