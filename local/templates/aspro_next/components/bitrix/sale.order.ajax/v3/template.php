...
?>
<?
//echo "1 - ". Main\Application::getDocumentRoot() . ' 2 - '. $templateFolder;
...
else
{
	...
	?>
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data" class="clio-order-form  ">
		<?
		...
		<div id="bx-soa-order" class="" style="opacity: 0">
			<!--	MAIN BLOCK	-->
			<div class="bx-soa">
				...
				<div class="order-product">
					<div id="bx-soa-basket" data-visited="false" class="clio-products bx-active bx-soa-section">
						<div class="clio-products-title">
							<h2 class="h2 clio-h2"><?=$arParams['MESS_BASKET_BLOCK_NAME']?></h2>
				...
				<div class="clio-order-info-details">
					<div class="bx-soa-section bx-active clio-order-tabs">
						<!--	REGION BLOCK	-->
						...
						<!--	BUYER PROPS BLOCK	-->
						<div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active clio-tabs-content active">
							<div class="bx-soa-section-content container-fluid clio-tabs-content_inner"></div>
						</div>
					</div>
				</div>
					...
					<? else: ?>
						<!--	DELIVERY BLOCK	-->
						<div id="bx-soa-delivery" data-visited="false" class="clio-order-production-method bx-soa-section bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
							<div class="clio-products-title">
								<h2 class="clio-h2">
									<span class="bx-soa-section-title-count"></span><?=$arParams['MESS_DELIVERY_BLOCK_NAME']?>
								</h2>
						...
						<!--	PAY SYSTEMS BLOCK	-->
						<div id="bx-soa-paysystem" data-visited="false" class="clio-order-payment-method bx-soa-section bx-active">
							<div class="clio-products-title">
								<h2 class="clio-h2">
									<span class="bx-soa-section-title-count"></span><?=$arParams['MESS_PAYMENT_BLOCK_NAME']?>
								</h2>
					...
					<?endif;?>
					<div id="bx-soa-total" class="clio-order-your-order">
						<div class="clio-products-title">
							<h2 class="clio-h2">Ваш заказ</h2>
						</div>
						<div class="bx-soa-cart-total-ghost"></div>
						<div class="clio-total-info-wrap"></div>
					</div>
	...
	if ($arParams['SHOW_PICKUP_MAP'] === 'Y' || $arParams['SHOW_MAP_IN_PROPS'] === 'Y')
	{
		if ($arParams['PICKUP_MAP_TYPE'] === 'yandex')
		{
			...
			?>
			<script src="<?=$scheme?>://api-maps.yandex.ru/2.1.50/?load=package.full&lang=<?=$locale?>&apikey=8f86e4d4-6552-4527-aea4-8f7cf18258bf&suggest_apikey=d0b251e5-4972-4a25-b6f7-5119ef616656"></script>
			<script>
