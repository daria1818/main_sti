								...
								<tr>
									<td class="foto-cell">
										<div class="image_wrapper_block">
											...
											$bShowOfferImg = empty($arItem["DETAIL_PICTURE"]) && empty($arItem["PREVIEW_PICTURE"]) 
													|| ( isset($arItem["PICTURE_FROM_OFFER"]) && !empty($arItem["PICTURE_FROM_OFFER"]) );
											?>
											<?if( !empty($arItem["DETAIL_PICTURE"]) || !empty($arItem["PREVIEW_PICTURE"]) || $bShowOfferImg ){?>
												<?
