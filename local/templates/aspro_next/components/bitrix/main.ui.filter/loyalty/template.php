...
<!-- Final :: Search -->
<div class="main-ui-filter-search <?=$filterSearchClass?>" id="<?=$arParams["FILTER_ID"]?>_search_container" style='display: none;'>
	<input
			type="text"
			tabindex="1" <?
...
<div id="<?=$arParams["FILTER_ID"]?>_GENERAL_template">
	<div class="main-ui-filter-wrapper <?=$filterWrapperClass?>">
		<div class="main-ui-filter-title">История операций</div>
