...
if ($arParams['USE_GIFTS'] === 'Y')
{
	...
	$giftParameters = array(
		...
		'DEFERRED_PAGE_ELEMENT_COUNT' => '10',
...
if (empty($arResult['ERROR_MESSAGE']))
{
    ...
    <div id="basket-root" class="bx-basket bx-<?=$arParams['TEMPLATE_THEME']?> bx-step-opacity zxczxc" style="opacity: 0;">
		<?
		if (
		...
		<?
			if ($arParams['USE_GIFTS'] === 'Y' && $arParams['GIFTS_PLACE'] === 'TOP')
			{
				...
				$giftParameters['BX_ID_CUSTOM_LOADER'] = 'custom-loader';
				$giftParameters['BX_ID_CUSTOM_LOADER_BG'] = 'custom-loader_bg';
				?>
				<div data-entity="parent-container">
					...
					<?
					//$template = $arParams["IS_ADMIN"] == "Y" ? ".defaultForAdmin" : ".default";
					$template = ".default";
