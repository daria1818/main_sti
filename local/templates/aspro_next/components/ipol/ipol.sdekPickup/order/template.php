...
<script>
    var IPOLSDEK_pvz = {
        ...
        buttonPOSTAMAT: '<a href="javascript:void(0);" class="SDEK_selectPVZ" onclick="IPOLSDEK_pvz.selectPVZ(\'#id#\',\'POSTAMAT\'); return false;"><?=$linkNamePOSTAMAT?></a>',/* html êíîïêè "âûáðàòü ÏÂÇ". */
        ...
        onLoad: function(ajaxAns){
            ...
            if($('#sdek_city').length>0){/* îáíîâëÿåì ãîðîä */
        ...
        checkPoint : function (pointId,mode){
              ...
              if (pointId) {
                if (typeof IPOLSDEK_pvz.cityPVZ[pointId] !== 'undefined') {
                  point = IPOLSDEK_pvz.cityPVZ[pointId];
        ...
        putCityPVZ : function (){
            ...
            for(var city in IPOLSDEK_pvz[IPOLSDEK_pvz.curMode]){
        ...
        choozePVZ: function(pvzId,isAjax){
            ...
            if(!point)
                return;
            console.log(IPOLSDEK_pvz.cityPVZ.pvzId)
            IPOLSDEK_pvz.pvzAdress=point.city+", "+point.Address+" #S"+pvzId;
