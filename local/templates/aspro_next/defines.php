<?
global $is404, $isIndex, $isStavropol, $isNovorossiisk, $isForm, $isWidePage, $isBlog, $isHideLeftBlock, $isShowTopAdvBottomBanner, $isShowFloatBanner, $isShowTizers, $isShowSale,
...
$isNovorossiisk = CSite::inDir(SITE_DIR.'novorossiisk/');
$isStavropol = CSite::inDir(SITE_DIR.'stavropol/');
...
if(!$isIndex && $isStavropol)
	$isIndex = $isStavropol;

if(!$isIndex && $isNovorossiisk)
	$isIndex = $isNovorossiisk;
