						...
						<select class="select-lektor" name="lektor" data-title="Выберите Лектора">
							...
							<?
              				foreach($arResult["LECTOR"] as $user){?>
								...
								<option value="<?=$user['ID']?>"><?=$user['UF_FIRST_NAME'] . ' ' . $user['UF_LAST_NAME']?></option>
							<?}?>
						</select>
	...
	<form class="modal-course__content" action="" novalidate>
		...
		<div class="modal-course__inputs">
			<div class="modal-course__name">
				<input type="text" name="UF_NAME" placeholder="Введите название курса" value="" required>
			</div>
			...
			<div class="modal-course__city">
				<div class="modal-course__city-input search-icon">
					<input type="text" name="UF_CITY_NAME" placeholder="Введите город" value="" autocomplete="off" required />
			...
			<div class="modal-course__checkbox">
				<label>
					<input type="checkbox" name="UF_THIS_LOC_DENT" value="Y">
					<div class="modal-course__checkbox-checkmark"></div>
					<div class="modal-course__checkbox-body">Проводится в УЦ STIDent</div>
				</label>
			</div>
...
<div class="change-schedule js-modal-change-schedule" role="dialog" aria-modal="true">
	...
	<button class='change-schedule__view-course js-view-course'>Создать курс</button>
</div>
