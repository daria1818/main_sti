...
file_put_contents($_SERVER['DOCUMENT_ROOT'].'/logs/ajax_timing.log', microtime(true));
...
Logger::writeLog(['ajax_after_prolog' => microtime(true)], '/logs/', 'ajax_timing');
...
global $APPLICATION;
Logger::writeLog(['ajax_before_component' => microtime(true)], '/logs/', 'ajax_timing');
