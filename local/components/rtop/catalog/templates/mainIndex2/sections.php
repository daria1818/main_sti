...
// Вместо получения ID текущего раздела, убираем эту часть
// и работаем без фильтра по конкретному разделу

// Фильтр для элементов будет без учета конкретного раздела
...
// Если нужно включать элементы подразделов
...
// Дополнительные параметры фильтра, если они нужны
