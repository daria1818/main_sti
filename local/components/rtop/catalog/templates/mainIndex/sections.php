...
$arResult["VARIABLES"]["SECTION_ID"] = 7834;
...
if($section){
	...
	// $arElementFilter = array("ACTIVE" => "Y", "IBLOCK_ID" => $arParams["IBLOCK_ID"]);
	// global $arrFilterProducts;
	
	
	
	// $arElementFilter["ID"] = $arrFilterProducts;
	...
	$itemsCnt = CNextCache::CIBlockElement_GetList(array("CACHE" => array("TAG" => CNextCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]))), CNext::makeElementFilterInRegion($arElementFilter, false, ""), array());
