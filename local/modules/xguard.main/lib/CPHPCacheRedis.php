...
use function /** @noinspection PhpUndefinedFunctionInspection */
    AddMessage2Log;
 ...
 */
class CPHPCacheRedis implements ICacheBackend,ICacheEngine
{
    /**
     * @var Redis $obRedis
     */
    ...
    public function CPHPCacheRedis()
    {
        if (class_exists('Redis')) {
            try {
                ...
                if (!defined('BX_REDISCACHE_CONNECTED') && self::$obRedis->ping() === '+PONG') {
            ...
            } /** @noinspection PhpUndefinedClassInspection */ catch (RedisException $e) {
    ...
    public function read(&$arAllVars, $basedir, $initdir, $filename, $TTL)
    {
        ...
        $arAllVars = unserialize($serialAllVars,['allowed_classes'=>true]);
        return true;
    }
    /**
