...
$APPLICATION->SetPageProperty("description", "⭐ Biodentine -15 капсул пророшка+15 капсул жидкость купить в интернет-магазине Stionline. Большой выбор товаров в наличии. 100% оригинал 🔝 +7 495 118-37-87.");
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_BLOCKS_ALL_ORDER" => "tizers,complect,nabor,offers,desc,char,galery,video,reviews,gifts,stores,docs,exp_goods,assoc_goods,recomend_goods,services,ask,custom_tab,goods,podborki,blog",
